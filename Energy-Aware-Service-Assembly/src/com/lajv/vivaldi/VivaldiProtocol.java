...
//		cyclonPid = Configuration.getPid(prefix + "." + PAR_CYCLON_PROT);
	...
	public void nextCycle(Node node, int protocolID) {
		...
		// Cast node to General node which also has a location
		GeneralNode netNode = (GeneralNode) node;
		...
		GeneralNode nbNode = (GeneralNode) linkable.getNeighbor(i);
		...
		// midaab: he does not use it in configuration
